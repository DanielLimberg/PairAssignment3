...
stargazer(M1, M2, M3, M4, type="text", dep.var.labels=c("DAX","Nikkei", "CAC", "FTSE"),
          covariate.labels=c("GDP Growth"), align = TRUE)
```
...
# Figure 8: *Expanded Model: Pooled OLS w/ new Dependent Variable (% Change tp previous Quarter)
...
# Figure 9: *Expanded Model: Pooled OLS w/ year dummies*
