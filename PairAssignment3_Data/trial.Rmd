...
```{r, echo=FALSE}
p5 <- ggplot(data = DEU, aes(x = Date, y = GDPq.gr, group, group = iso3c, color = iso3c)) + geom_line() + ggtitle("Quarterly GDP growth") + labs(x = "Quarters", y = "% Change to prev. Quarter")
...
```{r, echo=FALSE}
p6 <- ggplot(data = JPN, aes(x = Date, y = GDPq.gr, group, group = iso3c, color = iso3c)) + geom_line() + ggtitle("Quarterly GDP growth") + labs(x = "Quarters", y = "% Change to prev. Quarter")
...
```{r, echo=FALSE}
p7 <- ggplot(data = FRA, aes(x = Date, y = GDPq.gr, group, group = iso3c, color = iso3c)) + geom_line() + ggtitle("Quarterly GDP growth") + labs(x = "Quarters", y = "% Change to prev. Quarter")
...
```{r, echo=FALSE}
p8 <- ggplot(data = GBR, aes(x = Date, y = GDPq.gr, group, group = iso3c, color = iso3c)) + geom_line() + ggtitle("Quarterly GDP growth") + labs(x = "Quarters", y = "% Change to prev. Quarter")
...
```{r, echo=FALSE}
p9 <- ggplot(data = USA, aes(x = Date, y = GDPq.gr, group, group = iso3c, color = iso3c)) + geom_line() + ggtitle("Quarterly GDP growth") + labs(x = "Quarters", y = "% Change to prev. Quarter")
...
```{r, echo=FALSE}
p10 <- ggplot(data = ALL, aes(x = Date, y = GDPq.gr, group = iso3c, color = iso3c)) + geom_line() + ggtitle("Quarterly GDP growth") + labs(x = "Quarters", y = "% Change to prev. Quarter")
